...
angular.module('ngCart', ['ngCart.directives'])
    ...
    .service('ngCart', ['$rootScope', '$window', 'ngCartItem', 'store', function ($rootScope, $window, ngCartItem, store) {
        ...
        this.addItem = function (id, url, name, price, quantity, data) {
            ...
            if (typeof inCart === 'object'){
                ...
                var newItem = new ngCartItem(id, url, name, price, quantity, data);
        ...
        this.openItem=function(url){
            $("a[href='"+url+"'").parent().click();
        }
        this.empty = function () {
        ...
        this.$restore = function(storedCart){
            ...
            _self.$cart.invoice = storedCart.invoice;
            _self.$cart.tax = storedCart.tax;

            angular.forEach(storedCart.items, function (item) {
                _self.$cart.items.push(new ngCartItem(item._id, item._url,  item._name, item._price, item._quantity, item._data));
            });
            this.$save();
        };
    ...
    .factory('ngCartItem', ['$rootScope', '$log', function ($rootScope, $log) {
        ...
        var item = function (id,url, name, price, quantity, data) {
            this.setId(id);
            this.setUrl(url);
            this.setName(name);
            this.setPrice(price);
        ...
        item.prototype.setUrl = function(url){
            if (url)  this._url = url;
                ...
                $log.error('A url must be provided');
            }
        };
